...
void draw()
{
  ...
  for (Triangle t : myTriangles)
  {
    ...
    //fill(0, 102, 153);
    if (total == 20)
      text("A3 road‬, ‪Guildford‬‬‬", t.p3.x, t.p3.y);
    else if (total ==23)
      text("Arsenal Football Club‬, ‪EFL Cup‬‬", t.p3.x, t.p3.y);
    else if(total ==26 )
      text("Chrismas itv‬‬", t.p3.x, t.p3.y);
    else if(total ==29 )
      text("Zara Phillips‬, ‪Mike Tindall‬‬‬‬", t.p3.x, t.p3.y);
    else if(total == 30)
      text("OPEC‬‬‬‬", t.p3.x, t.p3.y);
    else if(total ==33)
      text("Keo Woolford‬, ‪Hawaii Five-0‬‬", t.p3.x, t.p3.y);
    else if(total ==36)
      text("Tony Bellew‬, ‪David Haye‬‬‬‬", t.p3.x, t.p3.y);
    else if(total ==39)
      text("Ilford‬, ‪fire‬‬", t.p3.x, t.p3.y);
    else if(total ==42)
      text("Barrow A.F.C.‬, ‪Macclesfield Town F.C.‬‬‬‬", t.p3.x, t.p3.y);
    else if (total ==45)
      text("Tiger Woods, Golfer", t.p3.x, t.p3.y);
    else if(total ==48)
      text("The Mummy‬, ‪Tom Cruis", t.p3.x, t.p3.y);
    else if(total ==52)
      text("Trevor Noah‬, ‪Donald Trumpl‬‬‬‬", t.p3.x, t.p3.y);
    else if(total ==52)
      text("Martin Allen", t.p3.x, t.p3.y);
    else if(total ==13)
      text("Gold‬, ‪New York City", t.p3.x, t.p3.y);
    else if(total ==16)
      text("The Weeknd‬, ‪Bella Hadid‬‬‬‬‬‬", t.p3.x, t.p3.y);
    else if(total ==19)
      text("Queens Park Rangers F.C‬‬", t.p3.x, t.p3.y);
    else if(total ==50)
      text("Boxing‬‬‬‬‬‬", t.p3.x, t.p3.y);
